...
| Sync/CI shape                                                           | `.github/workflows/sync-upstream.yml`, `.gitattributes` `merge=ours` rule, **deleted** `.github/workflows/release.yml`, AGENTS.md "Verifying" section                                                                                                                                                                                                                                                                | Fork has no CI; upstream's release workflow must never come back                                          |
