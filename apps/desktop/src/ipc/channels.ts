...
export const FORK_UPDATE_STATE_CHANNEL = "desktop:fork-update-state";
export const FORK_UPDATE_GET_STATE_CHANNEL = "desktop:fork-update-get-state";
export const FORK_UPDATE_CHECK_CHANNEL = "desktop:fork-update-check";
