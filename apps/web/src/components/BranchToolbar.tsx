...
export const BranchToolbar = memo(function BranchToolbar({
  ...
  return (
    <div className="chat-composer-context-strip -mt-4 mx-auto flex w-[calc(100%-2.75rem)] max-w-[calc(48rem-2.75rem)] items-center justify-between gap-2 px-1 pt-5 pb-1">
